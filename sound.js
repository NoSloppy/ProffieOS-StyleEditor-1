...
const CREATOR_LOGO_REGISTRY = [
  { names: ['bk sabers', 'bksabers'], domains: ['bksabers'], logoUrl: 'https://raw.githubusercontent.com/NoSloppy/ProffieOS-StyleEditor-1/master/demo_fonts/bk_logo.jpg' },
  { names: ['lord blako', 'lordblako'], domains: ['lordblako'], logoUrl: 'https://raw.githubusercontent.com/NoSloppy/ProffieOS-StyleEditor-1/master/demo_fonts/lord_blako_logo.jpg' },
  { names: ['fourzze'], domains: ['fourzze'], logoUrl: 'https://raw.githubusercontent.com/NoSloppy/ProffieOS-StyleEditor-1/master/demo_fonts/fourzze_logo.jpg' },
  { names: ['genesis custom sabers'], domains: ['genesiscustomsabers'], logoUrl: 'https://raw.githubusercontent.com/NoSloppy/ProffieOS-StyleEditor-1/master/demo_fonts/gcs_logo.jpg' },
  { names: ['jaydalorian'], domains: ['jaydalorian'], logoUrl: 'https://jaydalorian.com/wp-content/uploads/2026/03/cropped-file_000000009f2c71fd8efdeaa1e37a1e05-600x599.png' },
  { names: ['juansith'], domains: ['juansith'], logoUrl: 'https://raw.githubusercontent.com/NoSloppy/ProffieOS-StyleEditor-1/master/demo_fonts/juansith_logo.jpg' },
  { names: ['kyberphonic'], domains: ['kyberphonic'], logoUrl: 'https://raw.githubusercontent.com/NoSloppy/ProffieOS-StyleEditor-1/master/demo_fonts/kyberphonic_logo.jpg' },
  { names: ['ksith', 'k-sith'], domains: ['ksith'], logoUrl: 'https://raw.githubusercontent.com/NoSloppy/ProffieOS-StyleEditor-1/master/demo_fonts/ksith_logo.jpg' },
  { names: ['mountain sabers', 'mountainsabers'], domains: ['mountainsabers'], logoUrl: 'https://raw.githubusercontent.com/NoSloppy/ProffieOS-StyleEditor-1/master/demo_fonts/mountain_sabers_logo.jpg' },
  { names: ['madcow'], domains: ['madcow'], logoUrl: 'https://raw.githubusercontent.com/NoSloppy/ProffieOS-StyleEditor-1/master/demo_fonts/madcow_logo.jpg' },
  { names: ['syndicate custom relics', 'syndicate', 'syndicatecustomrelics'], domains: ['syndicate'], logoUrl: 'https://raw.githubusercontent.com/NoSloppy/ProffieOS-StyleEditor-1/master/demo_fonts/syndicate_custom_relics_logo.jpg' },
];
...
function isReadmeFilename(name) {
  ...
  /^(read|readme|readthisfirst)/i.test(normalizeReadmeName(name));
}
