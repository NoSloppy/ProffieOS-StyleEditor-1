...
function animate() {
// camera.position.set(0, 0, -500);  // 500 units out from origin on Z axis
...
// if (origin) {
//   // Use 8.0 for SABER_PIVOT_OFFSET if it isn't available as a variable yet
//   // origin.position.set(1.0 * 100.0, 0.04 * 100.0 + 8.0, 0);
