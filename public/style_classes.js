...
Blade.prototype.addEffect = function(type, location) {
  ...
  /* Both BC props (detonator and blaster) fire EFFECT_DESTRUCT to start the countdown. Done before the
  ...
  // BC detonator prop uses USER2 for the disarm effect, so it ends an armed lockup with endarm.
